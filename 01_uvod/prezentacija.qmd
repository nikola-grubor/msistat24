...
[Podaci]{.blue} se sastoje od varijabli. Gde varijabla predstavlja [meru]{.yellow} neke pojave.
...
> Kada merimo težinu u $kg$ obično zaokružimo, međutim u ovom slučaju ima smisla pričati o *preciznijim* merenjima ($70 \; \text{kg}$, $70.3467 \; \text{kg}$).
...
Varijable moraju da imaju barem dve vrednosti (inače bi bile konstante), ali vrednosti varijable mogu na različite načine da se odnose jedna sa drugom:
...
- Apsolutna nula: Skala ima nulu koja znači nešto (Kelvin vs. Celsius)
...
## Zadatak: vremesnke serije {.variant-one}

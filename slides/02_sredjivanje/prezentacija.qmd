...
## Dodatak: definicija relativnog rizka {.smaller}

Rizik
  : Je [proporcija]{.yellow}. 

$$ R = \frac{\text{broj infarkta}}{\text{ukupan broj pacijenata}} $$

Relativni rizik
  : Je [odnos proporcija]{.yellow}.
  
$$ RR = \frac{\text{rizik sa statinom}}{\text{rizik bez statina}} $$

Ako je [RR]{.yellow} $\lt1$ rizik je manji kod grupe koja je uzimala statin. [Relativni rizik]{.yellow} meri koje su šanse da se dogadjaj desi u grupi koja je uzimala lek u odnosu na onu koja nije.

## Dodatak: definicija apsolutnog rizika

Apsolutna redukcija rizika (ARR)
  : [Razlika]{.yellow} (ne odnos proporcija) između broja događaja kod pacijenata koji su pili statin i onih koji nisu.
...
*Grupišu se po [klasnim intervalima]{.yellow}*

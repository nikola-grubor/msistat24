...
bork %>% 
  ...
  labs(y = "%C20-22 masnih kiselina",
       z = "Senzitivnost insulina (mg/m2/min)")
```

## Pearsonov koeficijent korelacije

$H_0:$ Ispitivane varijable nisu povezane.
...
ggplot(datasaurus_dozen, aes(x = x, y = y)) +
  ...
  geom_smooth(method = "lm", formula = "y ~ x", col = "orange", se = FALSE) +
  facet_wrap(~dataset) +
  theme_blue()
```
...
## {background-image="slike/corr_xkcd.png" background-size="contain"}

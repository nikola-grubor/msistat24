...
tibble(
  ...
  theme(
    ...
    panel.border = element_rect(fill=NA,color="#01364C", linewidth=0.5, 
                                    linetype="solid"),
...
tibble(
  ...
  theme_void() +
  theme(
    plot.background = element_rect(fill = "#01364C"),
    panel.background = element_rect(fill = "#01364C"),
    panel.border = element_rect(fill=NA,color="#01364C", linewidth=0.5, 
                                    linetype="solid"),
...
tibble(
  ...
  labs(y = "Ukupan broj",
       x = "Broj respiratornih infekcija (%)")
```
